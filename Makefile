...
optimised: antichain.cpp antichain.h fileio.cpp fileio.h main.cpp progress_bar.h phases.h
	g++ antichain.cpp fileio.cpp main.cpp -o optimised -O3 -Wall -std=c++11 -DNDEBUG
...
test:  antichain.cpp antichain.h fileio.cpp fileio.h test.cpp test.h progress_bar.h phases.h
